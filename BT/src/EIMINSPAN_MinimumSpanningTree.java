...
class EIMINSPAN_MinimumSpanningTree {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (!pq.isEmpty()) {
            ...
            if (polledE.endpoint.discovered) {
                continue;
            }
            polledE.endpoint.discovered = true;
            totalDis += polledE.weight;
            countVertices--;

            for (Edge u : polledE.endpoint.adjList) {
                if (u.endpoint.discovered == false) {
                    pq.add(u);
                }
            }
        }
    ...
    static Vertex[] readGraph(int nOfVertex, int nOfEdges) {
        ...
        for (int i = 0; i < nOfEdges; i++) {
            ...
            vertices[u].addAdjNeghbor(w, vertices[v]);
            vertices[v].addAdjNeghbor(w, vertices[u]);
        }
    ...
    static class Vertex {
        ...
        public void addAdjNeghbor(int weight, Vertex endpoint) {
